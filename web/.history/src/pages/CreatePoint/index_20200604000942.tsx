...
const CreatePoint = () => {
    ...
    useEffect(() => {
        ...
        apiGenerica.get('https://servicodados.ibge.gov.br/api/v1/localidades/estados/'+selectedUF+'/municipios').then(response => {
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        ...
                        <div className="field">
                            ...
                            <select  name="city" id="city" value={selectedCIDADE}  >
